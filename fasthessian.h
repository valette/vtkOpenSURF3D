...
class FastHessian {
  ...
  private:
    ...
    cv::Matx41f* deriv4D(int d, int r, int c, ResponseLayer *t, ResponseLayer *m, ResponseLayer *b, bool corner);

    cv::Matx44f* hessian4D(int d, int r, int c, ResponseLayer *t, ResponseLayer *m, ResponseLayer *b, bool corner);
